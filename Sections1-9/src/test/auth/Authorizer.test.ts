...
import { SessionTokenDataAccess } from "../../../src/server_app/data/SessionTokenDataAccess";
import { UserCredentialsDataAccess } from "../../../src/server_app/data/UserCredentialsDataAccess";
...
jest.mock("../../../src/server_app/data/SessionTokenDataAccess", () => {
  return {
...
jest.mock("../../../src/server_app/data/UserCredentialsDataAccess", () => {
  return {
